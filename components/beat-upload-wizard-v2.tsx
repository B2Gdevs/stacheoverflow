              ...
              <Card className="bg-slate-900 border-2 border-slate-700">
                <CardContent className="p-8 space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      <Label htmlFor="beat-price" className="text-slate-300 font-medium">Price (cents)</Label>
                      <Input
                        id="beat-price"
                        type="number"
                        value={currentBeat.price}
                        onChange={(e) => handleBeatChange('price', parseInt(e.target.value) || 0)}
                        className="bg-slate-800 border-slate-600 text-white focus:border-amber-500 focus:ring-amber-500/20"
                        placeholder="2000"
                      />
                    </div>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <span className="ml-2 text-white">${(currentBeat.price / 100).toFixed(2)}</span>
                    </div>
                    <div>
